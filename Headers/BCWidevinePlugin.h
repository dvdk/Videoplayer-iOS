...
extern NSString * const BCEventWidevine;
extern NSString * const BCEventWidevineResume;
extern NSString * const BCEventWidevineDidResume;
extern NSString * const BCEventWidevineWillResume;

// Key in BCEventWidevineDid/WillResume event details for playback position.
// The value is of type NSValue, wrapping a CMTime struct.
extern NSString * const kBCEventWidevineResumePositionKey;

extern const NSUInteger kBCWidevinePluginWidevineStatusJailbroken;
